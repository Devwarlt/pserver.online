!function (t) {
    var e = function () {
        ...
        function n(e) {
            e = e || {}, this.cancelled = !1, this.lastUrl = null, this._send = e.transport ? i(e.transport) : t.ajax, this._get = e.rateLimiter ? e.rateLimiter(this._get) : this._get, this._cache = e.cache === !1 ? new r(0) : a
        }
        ...
        return n.setMaxPendingRequests = function (t) {
            ...
            _get: function (t, e, n) {
                ...
                function a() {
                    s--, delete o[t], h.onDeckRequestArgs && (h._get.apply(h, h.onDeckRequestArgs), h.onDeckRequestArgs = null)
                }

                var c, h = this;
                this.cancelled || t !== this.lastUrl || ((c = o[t]) ? c.done(i).fail(r) : u > s ? (s++, o[t] = this._send(t, e).done(i).fail(r).always(a)) : this.onDeckRequestArgs = [].slice.call(arguments, 0))
            }, get: function (t, n, i) {
                var r;
        ...
        function o(t, e) {
            ...
            for (var o = t.length, u = e.length; o > i && u > r;) t[i] < e[r] ? i++ : t[i] > e[r] ? r++ : (s.push(t[i]), i++, r++);
            return s
        }
        ...
        function r(i) {
            ...
            return s = {
                ...
                filter: null,
                ajax: {}
            }, (r = i.prefetch || null) && (r = e.isString(r) ? {url: r} : r, r = e.mixin(s, r), r.thumbprint = n + r.thumbprint, r.ajax.type = r.ajax.type || "GET", r.ajax.dataType = r.ajax.dataType || "json", !r.url && t.error("prefetch requires url to be set")), r
        }
        ...
        function s(n) {
            ...
            return o = {
                ...
                filter: null,
                ajax: {}
            }, (s = n.remote || null) && (s = e.isString(s) ? {url: s} : s, s = e.mixin(o, s), s.rateLimiter = /^throttle$/i.test(s.rateLimitBy) ? r(s.rateLimitWait) : i(s.rateLimitWait), s.ajax.type = s.ajax.type || "GET", s.ajax.dataType = s.ajax.dataType || "json", delete s.rateLimitBy, delete s.rateLimitWait, !s.url && t.error("remote requires url to be set")), s
        }

        return {local: i, prefetch: r, remote: s}
    }();
    !function (n) {
        "use strict";
    ...
    var c = function () {
        ...
        function n(n) {
            ...
            }) : this.$input.on("input.tt", a), this.query = this.$input.val(), this.$overflowHelper = i(this.$input)
        }
        ...
        var o = "ttDataset", u = "ttValue", a = "ttDatum";
        return n.extractDatasetName = function (e) {
            ...
            _render: function (n, i) {
                ...
                function s() {
                    function r(e) {
                        var n;
                        return n = t(c.suggestion).append(g.templates.suggestion(e)).data(o, g.name).data(u, g.displayFn(e)).data(a, e), n.children().each(function () {
                            t(this).css(h.suggestionChild)
                        }), n
                    }

                    var s, l;
                    return s = t(c.suggestions).css(h.suggestions), l = e.map(i, r), s.append.apply(s, l), g.highlight && p({
                ...
                if (this.$el) {
                    var f, g = this;
                    this.$el.empty(), f = i && i.length, !f && this.templates.empty ? this.$el.html(r()).prepend(g.templates.header ? l() : null).append(g.templates.footer ? d() : null) : f && this.$el.html(s()).prepend(g.templates.header ? l() : null).append(g.templates.footer ? d() : null), this.trigger("rendered")
                }
            }, getRoot: function () {
                return this.$el
            }, update: function (t) {
        ...
        return e.mixin(n.prototype, d, {
            _onSuggestionClick: function (e) {
                ...
                var e, n, i, r;
                if (this.isOpen) {
                    if (n = this._getCursor(), e = this._getSuggestions(), this._removeCursor(), i = e.index(n) + t, i = (i + 1) % (e.length + 1) - 1, -1 === i) return void this.trigger("cursorRemoved");
                    -1 > i && (i = e.length - 1), this._setCursor(r = e.eq(i)), this._ensureVisible(r)
                }
        ...
        function n(n) {
            ...
            n = n || {}, n.input || t.error("missing input"), this.isActivated = !1, this.autoselect = !!n.autoselect, this.minLength = e.isNumber(n.minLength) ? n.minLength : 1, this.$node = i(n.input, n.withHint), r = this.$node.find(".tt-dropdown-menu"), s = this.$node.find(".tt-input"), o = this.$node.find(".tt-hint"), s.on("blur.tt", function (t) {
                ...
                t.preventDefault()
            }), this.eventBus = n.eventBus || new l({el: s}), this.dropdown = new m({
                menu: r,
                datasets: n.datasets
        ...
        function i(e, n) {
            var i, s, u, a;
            i = t(e), s = t(c.wrapper).css(h.wrapper), u = t(c.dropdown).css(h.dropdown), a = i.clone().css(h.hint).css(r(i)), a.val("").removeData().addClass("tt-hint").removeAttr("id name placeholder required").prop("readonly", !0).attr({
                autocomplete: "off",
                spellcheck: "false",
                tabindex: -1
            }), i.data(o, {
                ...
                style: i.attr("style")
            }), i.addClass("tt-input").attr({autocomplete: "off", spellcheck: !1}).css(n ? h.input : h.inputWithNoHint);
            try {
                !i.attr("dir") && i.attr("dir", "auto")
            } catch (l) {
            }
            return i.wrap(s).parent().prepend(n ? a : null).append(u)
        }
