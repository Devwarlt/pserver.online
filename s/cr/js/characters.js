function drawCharacters() {
    function t() {
        function t(t) {
            ...
            if (t.data["class"]) {
                var u, f, m = classInfoById[t.data["class"]], p = _.detect(m[6], function (e) {
        ...
        var a = 0, n = {}, s = {}, r = 50, o = document.createElement("canvas"), c = o.getContext("2d"),
            i = document.createElement("canvas"), d = i.getContext("2d"), h = document.createElement("canvas"),
            l = h.getContext("2d");
        $(".character").each(function () {
            var t = $(this).data(), e = _.map(["class", "skin", "dye1", "dye2"], function (e) {
                return t[e]
            }).join(".");
            n[e] ? n[e].elements.push(this) : (n[e] = {data: t, offset: a, elements: [this]}, a++)
...
function makePortraitPopovers(t) {
    $("#" + t + " .character").each(function () {
        var t = $(this), e = classInfoById[parseInt(t.data("class"))], a = parseInt(t.data("skin")),
            n = _.detect(e[6], function (t) {
                return t[0] == a
            });
        t.popover({
            html: !0, content: makeCharacterDyeTable(t), placement: function (t, e) {
                var a = $(e).offset().top - $(window).scrollTop();
                return 200 > a ? "bottom" : "top"
            }, trigger: "hover", title: e[1] + " - " + n[1]
        })
    })
}
...
function makeCharacterDyeTable(t) {
    ...
    var a = '<table class="character-dyes">', n = t.data("class"), s = t.data("accessory-dye-id"),
        r = t.data("clothing-dye-id"), o = parseInt(t.data("count")), c = classInfoById[n];
