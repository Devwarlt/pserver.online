        ...
        tablesorter: new function () {
            ...
            function buildParserCache(e, t) {
                ...
                if (0 != e.tBodies.length) {
                    ...
                    if (n[0]) for (var o = [], a = n[0].cells, i = a.length, s = 0; i > s; s++) {
                        var d = !1;
            ...
            function detectParserForColumn(e, t, r, n) {
                for (var o = parsers.length, a = !1, i = !1, s = !0; "" == i && s;) r++, t[r] ? (a = getNodeFromRowAndCellIndex(t, r, n), i = trimAndGetNodeText(e.config, a), e.config.debug && log("Checking if value was empty on row:" + r)) : s = !1;
                for (var d = 1; o > d; d++) if (parsers[d].is(i, e, a)) return parsers[d];
                return parsers[0]
            }
            ...
            function buildCache(e) {
                ...
                for (var r = e.tBodies[0] && e.tBodies[0].rows.length || 0, n = e.tBodies[0].rows[0] && e.tBodies[0].rows[0].cells.length || 0, o = e.config.parsers, a = {
                    ...
                    if (s.hasClass(e.config.cssChildRow)) a.row[a.row.length - 1] = a.row[a.row.length - 1].add(s); else {
                        a.row.push(s);
            ...
            function appendToTable(e, t) {
                ...
                for (var n = t, o = n.row, a = n.normalized, i = a.length, s = a[0].length - 1, d = $(e.tBodies[0]), c = [], u = 0; i > u; u++) {
                    var l = a[u][s];
                    if (c.push(o[l]), !e.config.appender) for (var f = o[l].length, h = 0; f > h; h++) d[0].appendChild(o[l][h])
                }
            ...
            function computeTableHeaderCellIndexes(e) {
                for (var t = [], r = {}, n = e.getElementsByTagName("THEAD")[0], o = n.getElementsByTagName("TR"), a = 0; a < o.length; a++) for (var i = o[a].cells, s = 0; s < i.length; s++) {
                    var d, c = i[s], u = c.parentNode.rowIndex, l = u + "-" + c.cellIndex, f = c.rowSpan || 1,
                        h = c.colSpan || 1;
                    "undefined" == typeof t[u] && (t[u] = []);
                    for (var g = 0; g < t[u].length + 1; g++) if ("undefined" == typeof t[u][g]) {
                        d = g;
                        break
                    }
                    r[l] = d;
                    ...
                    if (this.tHead && this.tBodies) {
                        ...
                        fixColumnWidth(this), r.click(function (e) {
                            ...
                            if (!this.sortDisabled && i > 0) {
                                ...
                                if (this.order = this.count++ % 2, this.lockedOrder && (this.order = this.lockedOrder), e[o.sortMultiSortKey]) if (isValueInArray(s, o.sortList)) for (var d = 0; d < o.sortList.length; d++) {
                                    var c = o.sortList[d], u = o.headerList[c[0]];
                                    c[0] == s && (u.count = c[1], u.count++, c[1] = u.count % 2)
                                } else o.sortList.push([s, this.order]); else {
                                    if (o.sortList = [], null != o.sortForce) for (var l = o.sortForce, d = 0; d < l.length; d++) l[d][0] != s && o.sortList.push(l[d]);
